...
public class CircleButton extends View {
    ...
    public CircleButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        float shadowRadius = attributes.getFloat(R.styleable.CircleButton_circle_shadow_radius,
                SHADOW_RADIUS);
        float shadowOffsetX = attributes.getFloat(R.styleable.CircleButton_circle_shadow_offset_x,
                SHADOW_OFFSET_X);
        float shadowOffsetY = attributes.getFloat(R.styleable.CircleButton_circle_shadow_offset_y,
                SHADOW_OFFSET_Y);
